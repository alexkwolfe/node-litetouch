...
(function() {
  var EventEmitter, LiteTouch, Socket, acknowlegements, hex, pad, split,
  ...
  LiteTouch = (function(_super) {
    ...
    function LiteTouch(socket) {
      this.socket = socket;
      this.socket.pipe(split('\r')).on('data', (function(_this) {
